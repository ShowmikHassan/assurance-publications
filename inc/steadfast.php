 ...
 *   - assurance_pdf_invoice_due_row() does the same on the customer-facing
 *     PDF invoice generated by the "Print Invoices & Packing Slips for
 *     WooCommerce" (WebToffee) plugin — again via a filter it already
 *     exposes (wt_pklist_alter_order_template_html), not a template
 *     override, so it survives that plugin's updates too.
 *
 * @package Assurance
 */
